...
## 1. Descripción
    ...
    Este proyecto forma parte del Máster en Data Analytics de ThePower en el que se aplican los conociemientos adquiridos en Python y PowerBi.  
   
    Representa un cuadro de mando desarrollado en Power BI para analizar la actividad del Grupo SaDaAm durante el año 2025.   
   
    Incluye datos de ventas, artículos, franquiciados, locales, junto con un informe de conclusiones basado en los datos.  
...
## 3. Contenido del repositorio
    ...
    /py → scripts para generar las tablas originales y Proyecto final
